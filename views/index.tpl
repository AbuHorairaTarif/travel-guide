...
<!-- Additional input fields for flights -->
        <input type="text" class="form-control" id="location-from" placeholder="From Location" style="display: none;">
        <input type="text" class="form-control" id="location-to" placeholder="To Location" style="display: none;">
        <input type="date" class="form-control" id="departure-date" placeholder="Departure Date" style="display: none;">
        <input type="date" class="form-control" id="return-date" placeholder="Return Date" style="display: none;">
